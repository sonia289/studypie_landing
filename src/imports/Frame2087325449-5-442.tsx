...
import { imgRectangle, imgRectangle1 } from "./svg-bvlve";
  ...
  return (
    <div className="bg-white relative size-full">
      <div className="absolute bg-white h-[300px] left-0 overflow-clip top-0 w-[375px]">
        ...
        <div className="absolute contents inset-[2.67%_0_18.53%_0]" data-name="강의 이미지">
          <div className="absolute contents inset-[-22.86%_-17.42%_-7.01%_-17.95%]" data-name="Group">
            <div className="absolute contents inset-[-22.86%_-17.42%_-7.01%_-17.95%]" data-name="Clip path group">
              <div className="absolute contents inset-[-33.57%_-12.66%_-18.08%_-1.51%]" data-name="Group">
                <div className="absolute contents inset-[-33.57%_-12.66%_-18.08%_-1.51%]" data-name="Group">
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[27.71%_65.63%_43.42%_-1.42%] mask-position-[5.336px,_-61.992px_-75.125px,_-151.719px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle2} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[23.6%_26.85%_39.36%_36.63%] mask-position-[-137.367px,_-204.695px_-62.805px,_-139.398px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle3} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[18.71%_-12.66%_34.25%_74.54%] mask-position-[-279.535px,_-346.863px_-48.125px,_-124.719px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle4} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[59.82%_27.23%_-4.12%_35.75%] mask-position-[-134.066px,_-201.395px_-171.445px,_-248.039px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle5} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[-5.73%_65.8%_72.54%_-1.51%] mask-position-[5.664px,_-61.664px_25.195px,_-51.398px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle6} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[-20.01%_27.5%_75.74%_35.64%] mask-position-[-133.656px,_-200.984px_68.031px,_-8.563px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle7} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[-33.57%_-11.52%_80.6%_71.92%] mask-position-[-269.699px,_-337.027px_108.719px,_32.125px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle8} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[56.86%_65.81%_9.95%_-1.49%] mask-position-[5.594px,_-61.734px_-162.586px,_-239.18px]">
                    <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle9} />
                  </GroupRectangleBackgroundImage>
                  <GroupRectangleBackgroundImage additionalClassNames="inset-[65.02%_-11.63%_-18.08%_72.04%] mask-position-[-270.145px,_-337.473px_-187.047px,_-263.641px]">
        ...
        <div className="absolute flex h-[84.338px] items-center justify-center left-[-9.13px] top-[195.22px] w-[436.132px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="flex-none rotate-[352.757deg]">
            <div className="bg-[#435af7] font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] h-[29.623px] leading-[normal] not-italic overflow-clip relative text-[10.58px] text-center text-nowrap text-white w-[435.876px]" data-name="하단 띠배너">
        ...
        <div className="absolute bg-[#435af7] h-[32px] left-1/2 overflow-clip top-0 translate-x-[-50%] w-[375px]" data-name="상단 띠배너">
          <div className="absolute content-stretch flex gap-[13.261px] items-center left-[calc(50%+0.11px)] top-[calc(50%+0.19px)] translate-x-[-50%] translate-y-[-50%]">
            <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12.432px] text-center text-nowrap text-white">
            ...
            <a 
              ...
              className="bg-black h-[16.379px] overflow-clip relative rounded-[22.246px] shrink-0 w-[67.961px] cursor-pointer hover:bg-gray-800 transition-colors"
            >
              <p className="absolute font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[normal] left-[34.13px] not-italic text-[7.731px] text-center text-nowrap text-white top-[3.24px] tracking-[-0.6185px] translate-x-[-50%]">강의 보러 가기 →</p>
            </a>
          </div>
        </div>
      </div>
