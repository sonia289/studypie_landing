...
import { imgRectangle, imgRectangle1 } from "./svg-98opz";
...
function BackgroundImage1({ children, additionalClassNames = "", text, additionalClassNames1 = "" }: React.PropsWithChildren<BackgroundImage1Props>) {
  return (
    <div style={{ "--transform-inner-width": "351.21875", "--transform-inner-height": "44" } as React.CSSProperties} className={additionalClassNames}>
      <div className={clsx("flex-none", additionalClassNames)}>
        <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[normal] not-italic relative text-[30px] text-center text-nowrap text-white">{text}</p>
      </div>
    </div>
  );
}
...
function BackgroundImage({ additionalClassNames = "" }: BackgroundImageProps) {
  return <BackgroundImage1 additionalClassNames={clsx("absolute flex h-[82.674px] items-center justify-center translate-x-[-50%] w-[350.987px]", additionalClassNames)} text="비즈니스 영어 패키지 64%~" additionalClassNames1="rotate-[352.593deg]" />;
}
type Group626673BackgroundImageAndTextProps = {
  text: string;
  additionalClassNames?: string;
};

function Group626673BackgroundImageAndText({ text, additionalClassNames = "" }: Group626673BackgroundImageAndTextProps) {
  return <BackgroundImage1 additionalClassNames={clsx("absolute flex h-[134.067px] items-center justify-center translate-x-[-50%] w-[345.705px]", additionalClassNames)} text={text} additionalClassNames1="rotate-[343.763deg]" />;
}
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full">
      ...
      {/* 하단 띠배너2 - Scrolling Ticker */}
      <div className="absolute left-[-60px] top-[329px] overflow-hidden w-[1200px] h-[440.796px]" data-name="하단 띠배너2">
        <div className="absolute flex h-[440.796px] items-center justify-center left-0 top-[0.01px] w-[1218.483px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="flex-none rotate-[343.304deg]">
            <div className="bg-[rgba(67,90,247,0.6)] h-[86.415px] w-[1246.193px]" />
          </div>
        </div>
        <div className="ticker-wrapper-2 absolute left-[7.31px] top-[33.35px] w-[2000px] h-[400px]">
          <div className="ticker-content-2 whitespace-nowrap">
            <div className="inline-flex">
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-[180.16px] top-[261.01px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[145.33px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[33.35px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[-78.66px] mr-[200px]" />
            </div>
            <div className="inline-flex" aria-hidden="true">
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[-190.34px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[-306.02px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[-418px] mr-[200px]" />
              <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="relative inline-block left-0 top-[-530px] mr-[200px]" />
            </div>
          </div>
        </div>
      </div>

      {/* 하단 띠배너 - Scrolling Ticker */}
      <div className="absolute left-[-54.47px] top-[577.17px] overflow-hidden w-[1200px] h-[244.341px]" data-name="하단 띠배너">
        <div className="absolute flex h-[244.341px] items-center justify-center left-0 top-0 w-[1247.055px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="flex-none rotate-[352.687deg]">
            <div className="bg-[#435af7] h-[86.415px] w-[1246.193px]" />
          </div>
        </div>
        <div className="ticker-wrapper-1 absolute left-[34px] top-[24.82px] w-[2000px] h-[200px]">
          <div className="ticker-content-1 whitespace-nowrap">
            <div className="inline-flex">
              <BackgroundImage additionalClassNames="relative inline-block left-[175.49px] top-[130.82px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[76.82px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[24.82px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[-27.18px] mr-[200px]" />
            </div>
            <div className="inline-flex" aria-hidden="true">
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[-79.18px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[-131.18px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[-183.18px] mr-[200px]" />
              <BackgroundImage additionalClassNames="relative inline-block left-0 top-[-235.18px] mr-[200px]" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute h-[584px] left-[34px] top-[129px] w-[1014px]" data-name="카피">
      ...
      <div className="absolute bg-[#435af7] h-[65px] left-[calc(50%+0.5px)] overflow-clip top-0 translate-x-[-50%] w-[1081px]" data-name="상단 띠배너">
        <p className="absolute font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[normal] left-[calc(50%+1px)] not-italic text-[30px] text-center text-nowrap text-white top-[calc(50%-18.5px)] translate-x-[-50%]">비즈니스 영어 패키지 UPTO 64% + 12만원 할인</p>
      </div>

      <style>{`
        @keyframes scroll-ticker-1 {
          0% {
        ...
        .ticker-content-1 {
          display: inline-flex;
          animation: scroll-ticker-1 25s linear infinite;
        }

        .ticker-content-2 {
          display: inline-flex;
          animation: scroll-ticker-2 30s linear infinite;
        }
      `}</style>
    </div>
  );
