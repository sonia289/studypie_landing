...
import { imgRectangle, imgRectangle1 } from "./svg-6ca7r";
  ...
  return (
    <div className="bg-white relative size-full">
      <div className="absolute bg-white h-[300px] left-0 overflow-clip top-0 w-[375px]">
        ...
        {/* Horizontal Ticker Banner 2 */}
        <div className="absolute left-0 top-[120px] w-[375px] h-[32px] overflow-hidden bg-[#435af7]" data-name="하단 띠배너2">
          <div className="ticker-wrapper">
            <div className="ticker-content">
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
        ...
        {/* Horizontal Ticker Banner 1 */}
        <div className="absolute left-0 top-[210px] w-[375px] h-[32px] overflow-hidden" style={{ backgroundImage: "linear-gradient(90deg, rgb(67, 90, 247) 0%, rgb(57, 64, 201) 40%, rgb(92, 149, 255) 60%, rgb(18, 26, 78) 100%)" }} data-name="하단 띠배너">
          <div className="ticker-wrapper">
            <div className="ticker-content ticker-content-2">
              <span className="ticker-text">비즈니스 ��어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
              <span className="ticker-text">비즈니스 영어 패키지 64%~</span>
        ...
        <div className="absolute bg-[#435af7] h-[32px] left-1/2 overflow-clip top-0 translate-x-[-50%] w-[375px]" data-name="상단 띠배너">
          <div className="absolute content-stretch flex gap-[8px] items-center left-[calc(50%+0.5px)] top-1/2 translate-x-[-50%] translate-y-[-50%]">
            ...
            <a 
              ...
              className="bg-black h-[18px] overflow-clip relative rounded-[25.036px] shrink-0 w-[76px] cursor-pointer hover:bg-gray-800 transition-colors flex items-center justify-center"
            >
