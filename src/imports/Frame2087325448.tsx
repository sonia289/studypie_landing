...
export default function Frame() {
  return (
    <div className="bg-white relative size-full">
      ...
      <div className="absolute contents left-[-60px] top-[329px]" data-name="하단 띠배너2">
        <div className="absolute flex h-[440.796px] items-center justify-center left-[-60px] top-[329.01px] w-[1218.483px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="flex-none rotate-[343.304deg]">
            <div className="bg-[rgba(67,90,247,0.6)] h-[86.415px] w-[1246.193px]" />
          </div>
        </div>
        <div className="absolute contents left-[7.31px] top-[362.36px]">
          <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="left-[180.16px] top-[590.36px]" />
          <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="left-[573.06px] top-[474.68px]" />
          <Group626673BackgroundImageAndText text="비즈니스 영어 패키지 64%~" additionalClassNames="left-[957.38px] top-[362.35px]" />
        </div>
      </div>
      <div className="absolute contents left-[-54.47px] top-[577.17px]" data-name="하단 띠배너">
        <div className="absolute flex h-[244.341px] items-center justify-center left-[-54.47px] top-[577.17px] w-[1247.055px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
          <div className="flex-none rotate-[352.687deg]">
            <div className="bg-[#435af7] h-[86.415px] w-[1246.193px]" />
          </div>
        </div>
        <div className="absolute contents left-[34px] top-[601.99px]">
          <BackgroundImage additionalClassNames="left-[209.49px] top-[707.99px]" />
          <BackgroundImage additionalClassNames="left-[615.49px] top-[653.99px]" />
          <BackgroundImage additionalClassNames="left-[1012.49px] top-[601.99px]" />
        </div>
      </div>
